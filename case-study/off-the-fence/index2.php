        ...
        <div id="case-study-outer" class="cs-new-wild">
            ...
            <section id="case-study">
                <div id="case-study-info" class="col col-skew">
                    ...
                    <br>Off the Fence Productions ranked number 5 in the Top 30 True Indies in the 2014 Broadcast Indie Survey, and took the number 1 position in the top producers of ‘Popular Factual’. </p>
                    ...
                    <p>The brief was slick, simple and allowed Slamdunk Digital to create an easy to navigate informational microsite showing off some of the gorgeous shots taken by the film crew. The site is fully responsive allowing viewers to browse the site's content on all types of devices (Desktop/Mobile phone/Tablet). We expect to be doing many more of these supporting sites for Off the Fence in the upcoming future.</p>
