...
<html lang="en">
    <head>
        ...
        <title>Slam Dunk Digital - Tesco, Enotria</title>
        <meta name="title" content="Slam Dunk Digital | Tesco, Enotria">
    ...
    <body class="page-case-study">
        ...
        <!-- Case study Intro -->
        <div id="case-study-outer" class="cs-tesco">
            ...
            <section id="case-study-nav">
                <div class="col"><a href="../olympics/" class="go-prev" title="Previous Project"><i class="fa fa-2x fa-chevron-circle-left" aria-hidden="true"></i></a></div>
                <div class="col"><a href="/#work" class="go-all" title="All Projects"><i class="fa fa-th fa-2x" aria-hidden="true"></i></a></div>
                <div class="col"><a href="../closymarket/" class="go-next" title="Next Project"><i class="fa fa-2x fa-chevron-circle-right" aria-hidden="true"></i></a></div>
            </section>
            ...
            <section id="case-study">
                ...
                <div id="case-study-img" class="col col-no-skew">
                    <img src="img/home.jpg" alt="Tesco, Enotria">
                </div>
