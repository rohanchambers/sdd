...
<html lang="en">
    ...
    <body class="page-case-study">
        ...
        <!-- Case study Intro -->
        <div id="case-study-outer" class="cs-volvic-toughmudder">
            <div id="case-study-intro">
                ...
                <div id="intro-content">
                    <article class="left">
                        <h1>Volvic, Toughmudder</h1>
                        <p>Ignite your volcanicity</p>
                    </article>
                </div>
            </div><!-- End of case study intro -->

            <section id="case-study-nav">
                <div class="col"><a href="../ea/" class="go-prev" title="Previous Project"><i class="fa fa-2x fa-chevron-circle-left" aria-hidden="true"></i></a></div>
                <div class="col"><a href="/#work" class="go-all" title="All Projects"><i class="fa fa-th fa-2x" aria-hidden="true"></i></a></div>
                <div class="col"><a href="../jaguar/" class="go-next" title="Next Project"><i class="fa fa-2x fa-chevron-circle-right" aria-hidden="true"></i></a></div>
            </section>
            ...
            <section id="case-study">
                ...
                <div id="case-study-img" class="col col-no-skew">
                    <img src="img/home.jpg" alt="Volvic, Toughmudder">
                    <p><img src="img/mobile.jpg" alt="Volvic, Toughmudder"></p>
                </div>
