...
<html lang="en">
    ...
    <body>
        ...
        <section id="work">
            ...
            <div class="row">
                <div class="view view-first">  
                    <img src="assets/img/work/slamdunkdigital.jpg" alt="Phone Resq." /> 
                    <div class="mask">
                        <h2>Phone ResQ.</h2>
        ...
        <div class="overlay overlay-hugeinc">
            ...
            <nav role='navigation'>
                <ul>
                    <li class="home"><a href="#"><span class="letter-yellow">H</span><span class="letter-red">o</span><span class="letter-green">m</span><span class="letter-blue">e</span></a></li>
